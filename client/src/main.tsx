...
import { OrderCartPage } from './components/pages/order/order-cart-page.tsx';
import { OrderPayPage } from './components/pages/order/order-pay-page.tsx';
import { OrderCompletePage } from './components/pages/order/order-complete-page.tsx';
        ...
        createRoutesFromElements(
            <Route path="/" element={<App/>} errorElement={<ErrorPage/>}>
                ...
                <Route path="/order" element={<LazyOrderPage/>}>
                    <Route index={true} element={<OrderCartPage/>}/>
                    <Route path=":id/pay" element={<OrderPayPage/>}/>
                    <Route path=":id/complete" element={<OrderCompletePage/>}/>
                </Route>
