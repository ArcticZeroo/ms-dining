...
export interface IFullMapMarkersProps {
...
export const FullMapMarkers: React.FC<IFullMapMarkersProps> = ({ onSelectView, highlightedCafeIds, searchResultCafeIds, selectedCafeIds }) => {
